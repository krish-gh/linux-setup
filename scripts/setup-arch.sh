...
setup_apps() {
    ...
    sudo pacman -S --noconfirm --needed pacman-contrib base-devel nano git github-cli archlinux-wallpaper alsa-firmware sof-firmware alsa-oss alsa-plugins alsa-utils meld firefox gnome-keyring seahorse neofetch fastfetch vlc
