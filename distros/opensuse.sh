...
SYSTEM_PACKAGES_TO_INSTALL="fwupd Mesa-vulkan-device-select Mesa-vulkan-overlay alsa-firmware alsa-ucm-conf sof-firmware fprintd fprintd-pam power-profiles-daemon at-spi2-core"
...
FONTS_TO_INSTALL="liberation-fonts dejavu-fonts ubuntu-fonts google-noto-coloremoji-fonts google-noto-sans-fonts google-noto-serif-fonts google-noto-sans-mono-fonts google-roboto-fonts jetbrains-mono-fonts"
TERM_PACKAGES_TO_INSTALL="bash-completion nano starship fastfetch"
APP_PACKAGES_TO_INSTALL="MozillaFirefox MozillaFirefox-translations-common mozilla-openh264 gnome-keyring seahorse vlc onboard"
...
QT_PATCHES_TO_INSTALL="kvantum-manager kvantum-qt5 kvantum-qt6 kvantum-themes qt5ct qt6ct"
GNOME_PACKAGES_TO_INSTALL="gnome-menus gnome-tweaks gnome-terminal gnome-text-editor evolution-data-server python3-nautilus python3-pipx $QT_PATCHES_TO_INSTALL"
...
CINNAMON_PACKAGES_TO_INSTALL="patterns-cinnamon-cinnamon patterns-cinnamon-cinnamon_basis xed xreader xviewer metatheme-mint-common mint-y-icon-theme $QT_PATCHES_TO_INSTALL"
XFCE_PACKAGES_TO_INSTALL="patterns-xfce-xfce patterns-xfce-xfce_basis xfce4-whiskermenu-plugin xfce4-clipman-plugin xfce4-screenshooter xfce4-taskmanager light-locker lightdm-slick-greeter $QT_PATCHES_TO_INSTALL"
