...
PACKAGES_TO_REMOVE="baobab caribou celluloid drawing epiphany gedit hypnotix *libreoffice* *rhythmbox* simple-scan snapshot *thunderbird* *totem* *transmission* vim gnome-{calculator,calendar,characters,clocks,connections,contacts,font-viewer,maps,music,nettool,power-manager,screenshot,tour,weather,user-docs} warpinator *yelp*"
