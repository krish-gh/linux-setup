...
PACKAGES_TO_REMOVE="baobab caribou drawing epiphany gedit *libreoffice* *rhythmbox* simple-scan snapshot *totem* vim gnome-{calculator,calendar,characters,clocks,connections,contacts,font-viewer,games,maps,music,nettool,power-manager,screenshot,tour,weather,user-docs}* *yelp*"
