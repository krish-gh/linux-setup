...
SYSTEM_PACKAGES_TO_INSTALL="fwupd libnss-mdns mesa-vulkan-drivers firmware-sof-signed alsa-firmware-loaders pipewire-libcamera fprintd libpam-fprintd power-profiles-daemon"
...
XFCE_PACKAGES_TO_INSTALL="xfce4 xfce4-whiskermenu-plugin xfce4-clipman-plugin xfce4-screenshooter xfce4-taskmanager light-locker $QT_PATCHES_TO_INSTALL"
PACKAGES_TO_REMOVE=""
