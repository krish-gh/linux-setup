...
PACKAGES_TO_REMOVE="baobab celluloid epiphany gedit rhythmbox simple-scan snapshot totem vim gnome-{calculator,calendar,characters,clocks,connections,contacts,font-viewer,maps,music,nettool,power-manager,screenshot,tour,weather,user-docs} yelp *libreoffice*"
