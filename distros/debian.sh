...
SYSTEM_PACKAGES_TO_INSTALL="fwupd mesa-vulkan-drivers alsa-firmware-loaders alsa-ucm-conf firmware-sof-signed fprintd libpam-fprintd power-profiles-daemon"
...
HYPERV_PACKAGES_TO_INSTALL="hyperv-daemons"
VIRT_PACKAGES_TO_INSTALL="qemu-guest-agent"
FONTS_TO_INSTALL="fonts-recommended fonts-noto-core fonts-noto-ui-core fonts-noto-color-emoji fonts-jetbrains-mono"
TERM_PACKAGES_TO_INSTALL="bash-completion nano starship fastfetch"
APP_PACKAGES_TO_INSTALL="firefox firefox-locale-en-gb firefox-locale-en-us firefox-l10n-en-gb firefox-l10n-en-us wamerican wbritish gnome-keyring seahorse vlc onboard"
DEV_PACKAGES_TO_INSTALL="git build-essential python3-pip shfmt diffutils meld gh code"
GTK_PACKAGES_TO_INSTALL="xdg-desktop-portal-gtk gnome-themes-extra gnome-themes-extra-data"
QT_PACKAGES_TO_INSTALL="qtwayland5 qt6-wayland"
QT_PATCHES_TO_INSTALL="qt5-style-kvantum qt5-style-kvantum-themes qt6-style-kvantum qt6-style-kvantum-themes qt5ct qt6ct"
GNOME_PACKAGES_TO_INSTALL="gnome-menus gnome-tweaks gnome-terminal gnome-text-editor evolution-data-server python3-nautilus pipx $QT_PATCHES_TO_INSTALL"
...
CINNAMON_PACKAGES_TO_INSTALL="xed xreader xviewer xviewer-plugins mint-themes mint-y-icons $QT_PATCHES_TO_INSTALL"
XFCE_PACKAGES_TO_INSTALL="xfce4 xfce4-whiskermenu-plugin xfce4-clipman-plugin xfce4-screenshooter xfce4-taskmanager light-locker slick-greeter $QT_PATCHES_TO_INSTALL"
XFCE_MENU_LOGO="distributor-logo-debian"
PACKAGES_TO_REMOVE=""
