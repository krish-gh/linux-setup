...
QT_PACKAGES_TO_INSTALL="qt5-style-kvantum qt6-wayland qt{5,6}ct adwaita-qt{,6}"
...
PACKAGES_TO_REMOVE="baobab caribou drawing epiphany gedit *libreoffice* *rhythmbox* simple-scan snapshot *totem* vim gnome-{boxes,calculator,calendar,characters,clocks,connections,contacts,font-viewer,games,maps,music,nettool,power-manager,screenshot,tour,weather,user-docs}* *yelp*"
