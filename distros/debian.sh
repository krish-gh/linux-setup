...
PACKAGES_TO_REMOVE="baobab celluloid epiphany gedit *libreoffice* *rhythmbox* simple-scan snapshot *thunderbird* *totem* vim gnome-{calculator,calendar,characters,clocks,connections,contacts,font-viewer,maps,music,nettool,power-manager,screenshot,tour,weather,user-docs} *yelp*"
