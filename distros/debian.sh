...
APP_PACKAGES_TO_INSTALL="firefox{,-locale-en*,-l10n-en*} w{american,british} gnome-keyring seahorse vlc"
...
PACKAGES_TO_REMOVE="baobab celluloid cheese cups{,-common,-daemon,-server-common} drawing epiphany evolution gedit gthumb *hexchat* *libreoffice* mpv *redshift* *rhythmbox* shotwell simple-scan snapshot *thunderbird* totem *transmission* vim* gnome-{boxes,calendar,characters,clocks,connections,contacts,disk-utility,font-viewer,games,maps,music,nettool,power-manager,screenshot,sound-recorder,tour,weather}"
