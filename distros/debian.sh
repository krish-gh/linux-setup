...
PACKAGES_TO_REMOVE="baobab caribou drawing epiphany gedit gthumb *libreoffice* mpv pix *rhythmbox* simple-scan snapshot totem *transmission* vim gnome-{boxes,calculator,calendar,characters,clocks,connections,contacts,disk-utility,font-viewer,games,maps,music,nettool,power-manager,screenshot,tour,weather}"
