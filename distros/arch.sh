...
QT_PACKAGES_TO_INSTALL="qt{5,6}-wayland kwayland-integration xwaylandvideobridge"
...
KDE_PACKAGES_TO_INSTALL="plasma-meta gwenview kcalc kfind maliit-keyboard okular spectacle"
