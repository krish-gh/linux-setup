...
PACKAGES_TO_REMOVE="baobab celluloid epiphany gedit gthumb mpv galculator rhythmbox simple-scan snapshot thunderbird totem vim neofetch gnome-{boxes,calculator,calendar,characters,clocks,connections,contacts,disk-utility,font-viewer,maps,music,nettool,power-manager,screenshot,sound-recorder,tour,weather,user-docs} yelp"
