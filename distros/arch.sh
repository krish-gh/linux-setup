...
PACKAGES_TO_REMOVE="baobab celluloid epiphany gedit mpv galculator gthumb rhythmbox simple-scan snapshot system-config-printer thunderbird totem vim neofetch gnome-{boxes,calculator,calendar,characters,clocks,connections,contacts,disk-utility,font-viewer,maps,music,nettool,power-manager,screenshot,tour,weather,user-docs} yelp"
