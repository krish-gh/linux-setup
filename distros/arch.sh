...
FONTS_TO_INSTALL="noto-fonts noto-fonts-emoji ttf-liberation ttf-dejavu ttf-droid ttf-roboto ttf-ubuntu-font-family ttf-jetbrains-mono-nerd"
TERM_PACKAGES_TO_INSTALL="bash-completion nano-syntax-highlighting starship fastfetch"
APP_PACKAGES_TO_INSTALL="pacman-contrib firefox firefox-i18n-en-gb firefox-i18n-en-us gnome-keyring seahorse vlc onboard yay rate-mirrors reflector-simple"
...
QT_PACKAGES_TO_INSTALL="qt5-wayland qt6-wayland"
QT_PATCHES_TO_INSTALL="kvantum-qt5 qt5ct qt6ct"
GNOME_PACKAGES_TO_INSTALL="gnome-menus gnome-tweaks gnome-terminal gnome-text-editor evolution-data-server python-nautilus python-pipx $QT_PATCHES_TO_INSTALL"
