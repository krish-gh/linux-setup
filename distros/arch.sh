...
PACKAGES_TO_REMOVE="baobab celluloid cheese epiphany gedit gthumb mpv galculator rhythmbox shotwell simple-scan snapshot thunderbird totem vim neofetch gnome-{boxes,calculator,calendar,characters,clocks,connections,contacts,disk-utility,font-viewer,maps,music,nettool,power-manager,screenshot,sound-recorder,tour,weather,user-docs} yelp"
