...
SYSTEM_PACKAGES_TO_INSTALL="fwupd-efi fuse mesa-vulkan-drivers vulkan-loader alsa-firmware alsa-ucm alsa-sof-firmware fprintd fprintd-pam power-profiles-daemon"
...
FONTS_TO_INSTALL="liberation-fonts-common google-noto-fonts-common google-noto-emoji-fonts google-noto-color-emoji-fonts jetbrains-mono-fonts"
TERM_PACKAGES_TO_INSTALL="bash-completion nano starship fastfetch"
APP_PACKAGES_TO_INSTALL="firefox firefox-langpacks mozilla-openh264 gnome-keyring seahorse vlc onboard"
...
QT_PACKAGES_TO_INSTALL="qt5-qtwayland qt6-qtwayland"
QT_PATCHES_TO_INSTALL="kvantum kvantum-qt5 qt5ct qt6ct"
GNOME_PACKAGES_TO_INSTALL="gnome-menus gnome-tweaks gnome-terminal gnome-text-editor evolution-data-server nautilus-python pipx $QT_PATCHES_TO_INSTALL"
GNOME_EXT_MGR_PKG=""
KDE_PACKAGES_TO_INSTALL="plasma-workspace plasma-workspace-x11 gwenview kate kcalc kfind kwrite okular spectacle"
CINNAMON_PACKAGES_TO_INSTALL="xed xreader xviewer xviewer-plugins nemo-emblems nemo-fileroller nemo-preview nemo-python mint-themes mint-y-icons $QT_PATCHES_TO_INSTALL"
